...
const baseProject = {
  ...
  coverImageUrl: z.string({ required_error: 'Cover image is mandatory' }).min(1, 'Cover image is mandatory'),
  masterPlanUrl: z.string().url().optional(),
  brochureUrl: z.string().url().optional(),
  virtualTourUrl: z.string().url().optional(),
  featuredVideoUrl: z.preprocess((v) => (v === '' || v == null ? undefined : v), z.string().max(1000).optional()),
